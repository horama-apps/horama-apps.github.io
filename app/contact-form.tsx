      ...
      <div className="contact-panel">
        ...
        <form action="https://formsubmit.co/horama.3d@gmail.com" method="POST">
          ...
          <div className="contact-grid">
            ...
            <label><span>{t.app}</span><select name="app" required defaultValue=""><option value="" disabled>{t.appPrompt}</option><option>Horama Apps</option><option>Horama 3D</option><option>Framewise</option><option>GenAI Studio</option><option>Kiroku</option></select></label>
