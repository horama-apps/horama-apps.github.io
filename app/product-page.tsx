...
export function ProductPage({ slug, locale }: { slug: string; locale: Locale }) {
  ...
  return <main className={`product-page product-theme-${app.theme ?? "light"} product-${app.slug}`} style={{ "--app-color": app.color, "--app-ink": app.ink, "--app-accent": app.accent } as React.CSSProperties}>
