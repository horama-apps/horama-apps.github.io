...
export function HomePage({ locale }: { locale: Locale }) {
  ...
  return <main>
    ...
    </div><div className="orbit-card" aria-label={t.home.ecosystem}><div className="orbit-grid" /><div className="orbit-axis orbit-axis-x" /><div className="orbit-axis orbit-axis-y" /><div className="orbit-ring ring-one" /><div className="orbit-ring ring-two" /><div className="orbit-ring ring-three" /><i className="orbit-marker marker-one" /><i className="orbit-marker marker-two" /><i className="orbit-marker marker-three" /><div className="orbit-center"><img src="/horama-mark.png" alt="Horama" width="115" height="115" /></div>
