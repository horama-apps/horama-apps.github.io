...
const translations = {
  es: {
    ...
    home: {
      ...
      together: "Construyamos juntos", explore: "Conoce las apps", made: "HECHO EN MÉXICO", products: "4 PRODUCTOS",
      ...
      portfolioLabel: "02 — PORTAFOLIO VIVO", portfolioTitle: <>Cuatro apuestas.<br />Una misma casa.</>,
    ...
    product: {
      back: "← Volver al portafolio", appOf: "UNA APP DE HORAMA", roadmapButton: "Ver roadmap", repo: "Ver repositorio ↗", status: "PRODUCT STATUS", stage: "ETAPA ACTUAL", building: "BUILDING IN PUBLIC · HORAMA APPS", opportunity: "01 — LA OPORTUNIDAD", builtFor: "CONSTRUIDO PARA", features: "02 — LO QUE HACE", related: "PRODUCTOS CONECTADOS", roadmap: "03 — ROADMAP", roadmapTitle: <>De experimento<br />a producto sostenible.</>, roadmapBody: "Una ruta pública para saber qué ya existe, qué estamos construyendo y qué sigue.", states: { done: "COMPLETADO", current: "EN CONSTRUCCIÓN", next: "SIGUIENTE" }, needs: "04 — LO QUE NECESITAMOS", help: "Ayuda a que", grow: "siga creciendo.", contact: "Contactar a Horama Apps", pending: "POR CONFIRMAR",
    },
  },
  en: {
    ...
    home: {
      ...
      together: "Let’s build together", explore: "Meet the apps", made: "MADE IN MEXICO", products: "4 PRODUCTS",
      ...
      portfolioLabel: "02 — LIVING PORTFOLIO", portfolioTitle: <>Four bets.<br />One home.</>, portfolioBody: "Each product keeps its own identity and shares one promise: solve something real, grow openly, and find the right people to take it further.", headers: ["PRODUCT", "IN ONE SENTENCE", "VERSION", "STATUS"],
    ...
    product: {
      back: "← Back to portfolio", appOf: "A HORAMA APP", roadmapButton: "View roadmap", repo: "View repository ↗", status: "PRODUCT STATUS", stage: "CURRENT STAGE", building: "BUILDING IN PUBLIC · HORAMA APPS", opportunity: "01 — THE OPPORTUNITY", builtFor: "BUILT FOR", features: "02 — WHAT IT DOES", related: "CONNECTED PRODUCTS", roadmap: "03 — ROADMAP", roadmapTitle: <>From experiment<br />to sustainable product.</>, roadmapBody: "A public path showing what exists, what we are building, and what comes next.", states: { done: "COMPLETED", current: "IN PROGRESS", next: "NEXT" }, needs: "04 — WHAT WE NEED", help: "Help", grow: "keep growing.", contact: "Contact Horama Apps", pending: "TO CONFIRM",
    },
  },
} as const;
