...
const translations = {
  es: {
    ...
    home: {
      ...
      together: "Construyamos juntos", explore: "Conoce las apps", made: "HECHO EN MÉXICO", products: "5 PRODUCTOS",
      ...
      portfolioLabel: "02 — PORTAFOLIO VIVO", portfolioTitle: <>Cinco apuestas.<br />Una misma casa.</>,
  ...
  en: {
    ...
    home: {
      ...
      together: "Let’s build together", explore: "Meet the apps", made: "MADE IN MEXICO", products: "5 PRODUCTS",
      ...
      portfolioLabel: "02 — LIVING PORTFOLIO", portfolioTitle: <>Five bets.<br />One home.</>, portfolioBody: "Each product keeps its own identity and shares one promise: solve something real, grow openly, and find the right people to take it further.", headers: ["PRODUCT", "IN ONE SENTENCE", "VERSION", "STATUS"],
